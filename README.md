...
<p>Para realizar este tipo de pruebas, con el comando <EM>BEHAVE</EM> de python. Primero debemos seguir una lista de pasos, como primero tener instalado este <a href="https://www.youtube.com/watch?v=-IyA_Yvs8IQ" target="_blank" >lenguaje de programacion</a> en nuestro sistema, un entorno de programacion (como <a href="https://www.youtube.com/watch?v=kJP7f7cU03M">Pycharm</a> o el propio <a href="https://www.youtube.com/watch?v=HVzFLw5r2EM">Visual Estudio Code</a>) y un administrador de paquetes que nos permitira instalar el <EM>BEHAVE</EM>, que para este caso sera el <b><EM>PIP</EM></b>.</p>
        ...
        <p>Behave es un framework para pruebas BDD en Python utiliza features donde creamos la test suite para verificar un requerimiento determinado. Aqui se definen los pasos conocidos como en Cucumber, Given->When->Then, para verificar criterios</p> 
...
<h1> 6)Resultado pruebas</h1>
        ...
        <h4>Al ejecutar el comando BEHAVE</h4>
                <p>Al ejecutar las pruebas de aceptacion dadas las historias de usuario (7) en total, vemos que los 40 escenarios pasaron y se ejecutaron 121 pasos, nada fallo. El tiempo de ejecucion fue de 0.124s.</p>
                <img src="https://user-images.githubusercontent.com/54086394/102309004-d4be7400-3f35-11eb-8fb5-a6f13b817ac5.png"/>
                <p>Finalmente asi es como se crean unas pruebas automaticas, en este caso para el juego del 21 o BlackJack. Bajo el criterio de cada organizacion se pueden agregar mas historias de usuario.</p>
